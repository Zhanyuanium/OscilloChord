...
> **预期截图：**
> - `main.png` — 单八度、等宽键、隐藏音名标注、降号命名、正弦波、纯律、宽屏布局。按下 C 大三和弦，示波器显示其利萨如图，信息面板列出各音。
> - `settings.png` — 滚动到键盘和音频设置区域，所有选项可见。
...
- **三种律制** — 十二平均律、纯律（五度相生律）、五度相生率（毕达哥拉斯律），标准音频率 415--466 Hz 可调
- **四种波形** — 正弦波、方波、三角波、锯齿波
